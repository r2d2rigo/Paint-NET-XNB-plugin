                ...
                case PixelFormat.Alpha8:
                    {
                        ...
                        {
                            Array.Copy(new Alpha8Pixel(sourceData.Range(j, 1).ToArray()).ToRgba((platform == 'x')).Data, 0, finalData, j * 4, 4);
                        }
                    }
                    break;
                ...
                case PixelFormat.Bgr565:
                    {
                        ...
                        {
                            Array.Copy(new Bgr565Pixel(sourceData.Range(j * 2, 2).ToArray()).ToRgba((platform == 'x')).Data, 0, finalData, j * 4, 4);
                        }
                    }
                    break;
                case PixelFormat.Bgra4444:
                    {
                        for (int j = 0; j < dataSize / 2; j++)
                        {
                            Array.Copy(new Bgra4444Pixel(sourceData.Range(j * 2, 2).ToArray()).ToRgba((platform == 'x')).Data, 0, finalData, j * 4, 4);
                        }
                    }
                    break;
                case PixelFormat.Bgra5551:
                    {
                        for (int j = 0; j < dataSize / 2; j++)
                        {
                            Array.Copy(new Bgra5551Pixel(sourceData.Range(j * 2, 2).ToArray()).ToRgba((platform == 'x')).Data, 0, finalData, j * 4, 4);
                        }
                    }
                    break;
                case PixelFormat.Rgba:
                    {
                        ...
                        {
                            Array.Copy(new RgbaPixel(sourceData.Range(j * 4, 4).ToArray()).ToRgba((platform == 'x')).Data, 0, finalData, j * 4, 4);
                        }
